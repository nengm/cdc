 ...
 * @description
 * @author:miaoneng
 * @create:2021-12-01 21:28
 * <p>this class is copied from (https://github.com/DTStack/flinkx).
 **/
public class SqlUtil {
    ...
    public static String buildSelectSql(String listenerTables, boolean isCdb) {
        ...
        // 包含commit
        sqlBuilder.append(" or OPERATION='COMMIT' or OPERATION='ROLLBACK')");
     ...
     * @return
     */
    public static String buildSelectSql2(
