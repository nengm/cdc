 ...
 */
package com.mn.cdc.document;

import com.mn.cdc.annotation.NotThreadSafe;
import com.mn.cdc.util.Iterators;
import com.mn.cdc.util.MathOps;
...
final class BasicDocument implements Document {
    ...
    static final Function<Entry<? extends CharSequence, Value>, Field> CONVERT_ENTRY_TO_FIELD = new Function<Entry<? extends CharSequence, Value>, Field>() {
        @Override
    ...
    public int compareToUsingSimilarFields(Document that) {
        ...
        for (Entry<CharSequence, Value> entry : fields.entrySet()) {
