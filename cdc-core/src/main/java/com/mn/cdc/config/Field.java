...
/**
 * 一些定义。用field可以设置处理配置与默认值等。和处理数据的field区分开
...
public final class Field {
    public static enum Width {
        ...
        private Width() { /* compiled code */ }
    }

    public static enum Importance {
        HIGH, MEDIUM, LOW;

        private Importance() { /* compiled code */ }
    }
     ...
     * {@link Type#STRING}, a {@link #withRecommender(Recommender) recommender}
