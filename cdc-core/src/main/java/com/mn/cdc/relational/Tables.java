...
import com.mn.cdc.schema.DataCollectionFilters.DataCollectionFilter;
import com.mn.cdc.structure.Schema;
import com.mn.cdc.util.Collect;
import com.mn.cdc.util.FunctionalReadWriteLock;
...
public class Tables {
    ...
    public interface TableFilter extends DataCollectionFilter<TableId> {
        ...
        /**
         * 当前表的判断表达式，是否包含在其中，包含返回true，不包含返回false
         */
