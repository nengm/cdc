...
import com.mn.cdc.relational.Key.CustomKeyMapper;
import com.mn.cdc.relational.Key.KeyMapper;
import com.mn.cdc.relational.Selectors.TableIdToStringMapper;
import com.mn.cdc.config.*;
import com.mn.cdc.jdbc.JdbcValueConverters;
 ...
 * @description
 * @author:miaoneng
 * @create:2021-09-30 14:57
 **/
public abstract class RelationalDatabaseEngineConfig extends CommonEngineConfig {
    ...
    public static final Field HOSTNAME = Field.create(DATABASE_CONFIG_PREFIX + JdbcConfiguration.HOSTNAME)
            ...
            .withImportance(Field.Importance.HIGH)
            .required()
    ...
    public static final Field SERVER_NAME = Field.create(DATABASE_CONFIG_PREFIX + "server.name")
            ...
            .withImportance(Field.Importance.HIGH)
            .required()
            .withValidation(RelationalDatabaseEngineConfig::validateServerName)
    ...
    public static final Field TABLE_EXCLUDE_LIST = Field.create(TABLE_EXCLUDE_LIST_NAME)
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.MEDIUM)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateTableExcludeList)
    ...
    public static final Field TABLE_BLACKLIST = Field.create(TABLE_BLACKLIST_NAME)
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.LOW)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateTableBlacklist)
            .withInvisibleRecommender()
            .withDescription(
    ...
    public static final Field COLUMN_EXCLUDE_LIST = Field.create("column.exclude.list")
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.MEDIUM)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateColumnExcludeList)
    ...
    public static final Field COLUMN_BLACKLIST = Field.create("column.blacklist")
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.LOW)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateColumnBlacklist)
            .withInvisibleRecommender()
    ...
    public static final Field MSG_KEY_COLUMNS = Field.create("message.key.columns")
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.MEDIUM)
            .withValidation(RelationalDatabaseEngineConfig::validateMessageKeyColumnsField)
    ...
    public static final Field SCHEMA_EXCLUDE_LIST = Field.create(SCHEMA_EXCLUDE_LIST_NAME)
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.MEDIUM)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateSchemaExcludeList)
            .withInvisibleRecommender()
    ...
    public static final Field SCHEMA_BLACKLIST = Field.create("schema.blacklist")
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.LOW)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateSchemaBlacklist)
            .withInvisibleRecommender()
    ...
    public static final Field DATABASE_EXCLUDE_LIST = Field.create(DATABASE_EXCLUDE_LIST_NAME)
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.MEDIUM)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateDatabaseExcludeList)
    ...
    public static final Field DATABASE_BLACKLIST = Field.create(DATABASE_BLACKLIST_NAME)
            ...
            .withWidth(Field.Width.LONG)
            .withImportance(Field.Importance.LOW)
            .withValidation(Field::isListOfRegex, RelationalDatabaseEngineConfig::validateDatabaseBlacklist)
            .withInvisibleRecommender()
    ...
    // TODO - belongs to HistorizedRelationalDatabaseEngineConfig but should be move there
    // after MySQL rewrite
    ...
    protected static final ConfigDefinition CONFIG_DEFINITION = CommonEngineConfig.CONFIG_DEFINITION.edit()
            .type(
                    SERVER_NAME)
            .connector(
    ...
    protected RelationalDatabaseEngineConfig(Configuration config, String logicalName, Tables.TableFilter systemTablesFilter,
