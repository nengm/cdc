...
public class Timestamp {
    ...
    public static final String SCHEMA_NAME = "cdc.time.Timestamp";
    ...
    /**
     * Get the number of milliseconds past epoch of the given {@link LocalDateTime}, {@link java.time.LocalDate},
