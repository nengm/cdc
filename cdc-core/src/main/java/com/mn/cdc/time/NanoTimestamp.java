...
public class NanoTimestamp {
    ...
    public static final String SCHEMA_NAME = "cdc.time.NanoTimestamp";
    ...
    /**
     * Get the number of nanoseconds past epoch of the given {@link LocalDateTime}, {@link java.time.LocalDate},
