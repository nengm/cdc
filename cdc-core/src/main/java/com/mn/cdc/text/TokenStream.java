 ...
 */
package com.mn.cdc.text;

import com.mn.cdc.annotation.Immutable;
import com.mn.cdc.annotation.NotThreadSafe;
import com.mn.cdc.function.BooleanConsumer;
import com.mn.cdc.relational.ddl.DdlTokenizer;
 ...
 * passed into the {@link Tokenizer#tokenize(CharacterStream, Tokens) tokenize(...)} method, and use a
