...
public abstract class AbstractSourceInfo {
    ...
    public static final String CDC_VERSION_KEY = "version";
    public static final String CDC_CONNECTOR_KEY = "connector";
    ...
    private final CommonEngineConfig config;

    protected AbstractSourceInfo(CommonEngineConfig config) {
        this.config = config;
    }
