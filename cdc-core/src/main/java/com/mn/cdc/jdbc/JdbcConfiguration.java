...
import com.mn.cdc.config.Field.Type;
...
/**
 * A specialized configuration for the Debezium driver. This defines several known {@link Field
...
public interface JdbcConfiguration extends Configuration {
    ...
    /**
     * 建立数据库连接时要设置的sql语句，用分号分割，典型用例就是设置会话参数，没有默认值
     */
