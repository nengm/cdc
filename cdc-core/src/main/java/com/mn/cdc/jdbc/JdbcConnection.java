...
import com.mn.cdc.annotation.NotThreadSafe;
...
import com.mn.cdc.util.BoundedConcurrentHashMap;
import com.mn.cdc.util.BoundedConcurrentHashMap.*;
import com.mn.cdc.util.Collect;
import com.mn.cdc.util.ColumnUtils;
...
public class JdbcConnection implements AutoCloseable {
    ...
    public static Field[] combineVariables(Field[] overriddenVariables,
    ...
    public static String findAndReplace(String url, Properties props, Field... variables) {
    ...
    private void doClose() throws SQLException {
        ...
        try {
            ...
            throw new CdcException(e.getCause());
        }
    ...
    public void readSchema(Tables tables, String databaseCatalog, String schemaNamePattern,
        ...
        if (totalTables == tableIds.size() || config.getBoolean(RelationalDatabaseEngineConfig.SNAPSHOT_FULL_COLUMN_SCAN_FORCE)) {
     ...
     */
    public Statement readTableStatement(CommonEngineConfig connectorConfig, OptionalLong tableSize) throws SQLException {
     ...
     */
    public PreparedStatement readTablePreparedStatement(CommonEngineConfig connectorConfig, String sql, OptionalLong tableSize) throws SQLException {
        int fetchSize = connectorConfig.getSnapshotFetchSize();
