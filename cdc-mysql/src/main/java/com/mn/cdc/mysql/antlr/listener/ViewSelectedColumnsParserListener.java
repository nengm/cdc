                ...
                if (selectElementContext instanceof MySqlParser.SelectStarElementContext) {
                    ...
                    if (fullColumnNameContext.dottedId(0) != null) {
                        ...
                        if (fullColumnNameContext.dottedId(1) != null) {
                            ...
                            tableName = AntlrDdlParser.withoutQuotes(fullColumnNameContext.dottedId(0).getText().substring(1));
                            columnName = AntlrDdlParser.withoutQuotes(fullColumnNameContext.dottedId(1).getText().substring(1));
                        }
                        else {
                            // final look of fullColumnName e.g. Persons.FirstName
                            columnName = AntlrDdlParser.withoutQuotes(fullColumnNameContext.dottedId(0).getText().substring(1));
                        }
                    }
