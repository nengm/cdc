...
public class MySqlOffsetContext {
    ...
    public MySqlOffsetContext(boolean snapshot, boolean snapshotCompleted,  SourceInfo sourceInfo) {
        this.sourceInfo = sourceInfo;
        sourceInfoSchema = sourceInfo.schema();

    }

    public MySqlOffsetContext(MySqlEngineConfig connectorConfig, boolean snapshot, boolean snapshotCompleted, SourceInfo sourceInfo) {
        this(snapshot, snapshotCompleted, sourceInfo);
    }
    ...
    public static MySqlOffsetContext initial(MySqlEngineConfig config) {
    ...
    public String toString() {
        return "MySqlOffsetContext [sourceInfoSchema=" + sourceInfoSchema + ", sourceInfo=" + sourceInfo
                + ", snapshotCompleted=" + snapshotCompleted + ", restartGtidSet=" + restartGtidSet + ", currentGtidSet=" + currentGtidSet
