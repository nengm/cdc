...
import com.mn.cdc.basesourceinfo.AbstractSourceInfoStructMaker;
...
public class MySqlSourceInfoStructMaker extends AbstractSourceInfoStructMaker<SourceInfo> {
    ...
    public MySqlSourceInfoStructMaker(String connector, String version, CommonEngineConfig connectorConfig) {
